...
namespace TodoApi.Controllers
{
    ...
    public class TodoItemsController : ControllerBase
    {
        ...
        {
            var todoItem = new TodoItem {Name = todoDTO.Name, IsComplete = todoDTO.IsComplete };
        ...
        private static TodoItemsDTO ItemToDTO(TodoItem todoItem) => new TodoItemsDTO { Id = todoItem.Id, Name = todoItem.Name, IsComplete = todoItem.IsComplete };
    }
}
